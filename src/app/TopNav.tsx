...
export default function TopNav({
  ...
  // —— Temporary account: minimal shell (name + language + logout) ——
  if (projectTemp) {
    return (
      <>
        ...
        <div className="hidden items-center justify-between gap-4 border-b border-gray-200 bg-[#F2F2F7] pb-3 px-4 pt-2 sm:flex sm:px-0">
          <Link href="/projects" className="flex min-w-0 items-center gap-4">
